"""
Run experiments matching paper's evaluation
"""
...
class ExperimentRunner:
    ...
    def run_accuracy_experiment(self, seq_lengths: List[int], 
                               ...
                               num_pairs: int = 30000) -> Dict:
        """
        Run accuracy experiments across different configurations.
        
        Args:
            seq_lengths: List of sequence lengths to test
            edit_thresholds: List of edit thresholds to test
            num_pairs: Number of sequence pairs per configuration
        ...
        for seq_length in seq_lengths:
            for edit_threshold in edit_thresholds:
                ...
                avg_shouji_time = np.mean(shouji_times) * 1000  # Convert to ms
    ...
    def run_scalability_experiment(self, base_seq_length: int = 100,
        ...
        """
        Test scalability with varying edit thresholds.
        
        Args:
            base_seq_length: Sequence length to use
            edit_threshold: Base edit threshold
...
def main():
    ...
    print("="*70)
    print("SHOUJI REIMPLEMENTATION - EXPERIMENTS")
    print("="*70)
